...
data Transform = Translate Vec | Rotate R | Compose Vec R
...
instance Mon Transform where 
  ...
  (><) (Translate v) (Rotate r) = Compose v r
  (><) (Compose (V x y) r) (Translate (V x1 y1)) = Compose (V (x + x1) (y + y1)) r
  (><) (Compose v r) (Rotate r1) = Compose v (r + r1)
