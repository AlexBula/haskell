...
transStmt x = case x of
  ...
  Brk -> failure x
  Cont -> failure x
  If expr block -> failure x
  IfElse expr block1 block2 -> failure x
...
transVar x = case x of
  Var type_ ident -> failure x
transType :: Type -> Result
transType x = case x of
  RType regtype -> failure x
  FType funtype -> failure x
transRegType :: RegType -> Result
transRegType x = case x of
  Int -> failure x
  Str -> failure x
  Bool -> failure x
  Void -> failure x
...
transFunType x = case x of
  Function type_ types -> failure x
transExpr :: Expr -> Result
transExpr x = case x of
  EVar ident -> failure x
  EFun vars block -> failure x
